...
!            CALL dressinflow(SS,LL,HE,EL1,R,PSI)
            ...
            call dressinflow(lamil, lami, lamd, mu, rb, psi)
...
subroutine linearinflow(THIS,lamids, lami, lamd, mu, rb, psi)
!->+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!-> modules used:
implicit none
CLASS(INFLOW) :: THIS
...
!-> main body:
    ...
    IF(THIS%LINTYPE.EQ.0) THEN
        CALL dressinflow(lamids, lami, lamd, mu, rb, psi)
...
subroutine dressinflow(lamids, lami, lamd, mu, rb, psi)
!->+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!-> modules used:
implicit none
